...
function requestParser(options) {
  ...
  return [
    ...
    multer(options.multipart).any(),  // Accept any multipart fields
      ...
      if (req.files && Array.isArray(req.files)) {
        ...
        req.files.forEach(function(file) {
          ...
          var transformedFile = {
            ...
            name: file.originalname, // multer 0.x used 'name' instead of 'originalname'
  ...
  multipart: {
    ...
    storage: multer.diskStorage({
      ...
      filename: function (req, file, cb) {
        // Keep original filename to maintain backward compatibility
